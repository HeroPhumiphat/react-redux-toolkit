...
export default function CreateProduct() {
  ...
  const onSubmitForm = (event) => {
    ...
    let message = { alert: 'Success', message: `You have successfully added a new product named "${name}".`}
                ...
                <div className='boxCard mb-8 cursor-pointer rounded-md p-0.5' style={{boxShadow: '2px 2px 5px #c1c1c1'}}>
                  {
                    image === ''
                      ...
                      : <div className='w-[180px] h-[200px] rounded-md cursor-pointer' style={{backgroundImage: `url(${URL?.createObjectURL(image)})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat'}}></div>
                  }
